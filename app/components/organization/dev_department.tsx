...
export default function DevDepartment() {
    return (
        <section id="dev" className="w-full max-w-5xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            ...
            <div className="p-6 md:p-8 lg:p-10">
                <div className="max-w-3xl mx-auto text-center">
                    <h3 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">What We Do</h3>
                ...
                <div className="mt-10 md:mt-12">
                    <h3 className="text-2xl md:text-3xl font-bold text-gray-800 text-center mb-8">Our Tech Stack</h3>
